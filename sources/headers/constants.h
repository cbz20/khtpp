...
inline extern const int maximum_number_of_tangle_strands {10};///< (conservative) upper limit for the number of allowed tangle strands to prevent the computer from attempting calculations whose runtime might exceed the age of the universe. 
