...
This option was developed and extensively used for the paper \cite KWZ_strong_inversions. It computes the invariants of the quotient tangle of a strongly invertible knot specified by a \ref StrongInversions "symmetric diagram". The quotient tangle is framed such that the closure with the rational tangle of slope \f$\infty\f$ is the unknot and the rational closure of slope 0 corresponds to surgery along the longitude for the knot. This agrees with the conventions used in \cite Watson2010, \cite Watson2012, and \cite Watson2017. 
